...
/**
 *
 * @author luisGonzalezss
 */
public class HostOnline extends javax.swing.JDialog implements Observer {
     ...
     */
    public HostOnline(java.awt.Frame parent, boolean modal, Juego misDatos, ArrayList<NavesCamino> listNaves, JTextArea panelMensajes, AccionesOnline datosOnline, ArrayList<Resultados> finales, JPanel panelJuego, JLabel lblTurno, JTextField txtNaves, JButton btnTurno) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Cliente cliente = new Cliente(7000, texto.getText());
