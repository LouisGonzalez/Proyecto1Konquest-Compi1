...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Mar 30 22:52:17 CST 2020
  */
    ...
    throws java.lang.Exception
    {
     ...
     if(e == null){ RESULT=null; } else { if(a.getTodoCorrecto() == false){ RESULT=null; } else { a.setNombrePlaneta(c.toString()); e.add(a);   RESULT=e; } } 
		...
		ArrayList<Replay> a = (ArrayList<Replay>)((java_cup.runtime.Symbol) CUP$SintaxReplay$stack.elementAt(CUP$SintaxReplay$top-1)).value;
		 if(a == null){ System.out.println("AQUI SI ENTRO"); parser.panelMensajes.setText(parser.totalErrores); } else {  System.out.println("LLEGO AQUI");  parser.traspasoDatosFlotas(parser.listReplay, a);  }       
