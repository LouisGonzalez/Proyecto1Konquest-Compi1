...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Mar 17 20:16:34 CST 2020
  */
public class SintaxCreacionMapa extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public SintaxCreacionMapa(AnalizadorLexico lex, CreacionMapa tablero, JTextArea panelMensajes, int contador, JTextField txtNaves, ArrayList<Juego> datosJuego, JButton btnTurno, ArrayList<NavesCamino> listNaves, JPanel panelJuego){
        super(lex);
    ...
    public void crearCuadriculaJuego(Juego misDatos){
        tablero.creacionCuadricula(misDatos, txtNaves, contador, navesCamino, btnTurno);
    }
  ...
  public final java_cup.runtime.Symbol CUP$SintaxCreacionMapa$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$SintaxCreacionMapa$act_num)
		...
		int aright = ((java_cup.runtime.Symbol)CUP$SintaxCreacionMapa$stack.elementAt(CUP$SintaxCreacionMapa$top-1)).right;
		Jugadores a = (Jugadores)((java_cup.runtime.Symbol) CUP$SintaxCreacionMapa$stack.elementAt(CUP$SintaxCreacionMapa$top-1)).value;
		 if(a.getNombre()==null || a.getPlanetas()==null || a.getColor()==null || a.getTipo()==null ){ System.out.println("ERROR, Falta de un archivo"); } else { ArrayList<Jugadores> misJugadores = new ArrayList<>(); a.setEnJuego("true");  a.setMisPlanetas(new ArrayList<>()); misJugadores.add(a); RESULT=misJugadores; } 
		...
		ArrayList<Jugadores> e = (ArrayList<Jugadores>)((java_cup.runtime.Symbol) CUP$SintaxCreacionMapa$stack.peek()).value;
		 if(a.getNombre()==null || a.getPlanetas()==null || a.getColor()==null || a.getTipo()==null ){ System.out.println("ERROR, Falta de un archivo"); } else { a.setEnJuego("true");  a.setMisPlanetas(new ArrayList<>());  e.add(a); RESULT=e; } 
